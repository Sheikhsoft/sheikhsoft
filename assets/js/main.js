...
(function ($) {
    ...
    $window.on('scroll', function () {
        ...
        if (scroll <= 50) {
            ...
            logoinner.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo-inner.png');
            logodefault.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo.png');
            logowhite.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo-white.png');
            logowhitedark.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo-white.png');
            logo2.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo-2-light.png');
            logo3.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo-2-dark.png');
        } else {
            $("header").removeClass("fixedHeader").addClass("scrollHeader");
            logoinner.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo.png');
            logodefault.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo.png');
            logowhite.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo-white.png');
            logowhitedark.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo-dark.png');
            logo2.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo-2-dark.png');
            logo3.attr('src', $baseurl + 'themes/sheikhsoft/assets/img/logos/logo-2-dark.png');
        }
    });
    $window.on('scroll', function () {
